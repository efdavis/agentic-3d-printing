...
- **Colorization** for Bambu: per-extruder multi-object 3MFs. See `reference_bambu_*` auto-memories for the pattern. The `paint_color` bitstream only renders in Bambu's Color Painting tool, not Prepare view.
